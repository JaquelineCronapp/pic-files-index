/* PrismJS 1.16.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+json+regex&plugins=line-highlight+line-numbers+toolbar+unescaped-markup+show-language+copy-to-clipboard */
...
(function () {
	...
	/**
	 * Plugin name which is used as a class name for <pre class="line-numbers"> which is activating the plugin
	 * @type {String}
	 */
	 ...
	 * @param {Element} element <pre class="line-numbers"> element
	 */
	...
	Prism.hooks.add('complete', function (env) {
		...
		// Add the class 'line-numbers' to the <pre class="line-numbers">
...
(function(){
	...
	var hook = Prism.plugins.toolbar.hook = function (env) {
		...
		// Create wrapper for <pre class="line-numbers"> to prevent scrolling toolbar with content
		...
		// Add our toolbar to the currently created wrapper of <pre class="line-numbers"> tag
	...
	Prism.plugins.toolbar.registerButton('copy-to-clipboard', function (env) {
		...
		function registerClipboard() {
			...
			clip.on('error', function () {
				linkCopy.textContent = 'Pressione Ctrl+C para copiar';
...
document.addEventListener('pic:ready', function () {
    ...
    if (isIE || isEdge) {
        $('div.code-toolbar > .toolbar').css('opacity', '1');
    }
});
